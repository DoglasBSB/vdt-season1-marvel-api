...
// Comando costumizado do Cypress
...
Cypress.Commands.add('back2ThePast', function(){
     ...
     cy.api({
        method: 'DELETE',
        url: '/back2thepast/62bb619697d19e00169b351f',
        failOnStatusCode: false
    }).then(function(response){
        expect(response.status).to.eql(200)
    })
...
// GET requisição que testa a obtenção dos personagens
...
Cypress.Commands.add('populateCharacters', function(characters){
    ...
    //Loop para percorrer a lista "forEach"
